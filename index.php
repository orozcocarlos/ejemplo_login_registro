...
if(isset($_POST["ingresar"])){
	...
	$password_encriptacion = sha1($password);
	$sql="SELECT idusuarios FROM usuarios WHERE usuario ='$usuario' AND password='$password_encriptacion'";
...
if (isset($_POST["registrar"])){
	...
	if ($filas > 0){
		...
		$sqlusuario = "INSERT INTO usuarios(NombreC,Correo,usuario,password) VALUES('$nombre','$correo','$usuario','$password_encriptacion')";
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; Crud Basico </h4>
							</div>
